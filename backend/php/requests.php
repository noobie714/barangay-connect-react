<?php
// ============================================================
//  php/requests.php  –  Document Request CRUD (self-contained)
// ============================================================
...
function getDB(): PDO {
    ...
    if ($pdo === null) {
        ...
        $dbname = 'if0_41886132_barangay';  // ← CHANGE THIS
        $username = 'if0_41886132';            // ← CHANGE THIS
        $password = '2f5xhmFrHOIfeiN';      // ← CHANGE THIS
